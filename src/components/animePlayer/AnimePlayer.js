...
const AnimePlayer = () => {
    ...
    const translationsList = useSelector(
        state => state.anime.voiceTranslations
    );
                ...
                <div className='player__settings'>
                    <div className='player__header'>
                        <div className='player__body'>
                            <div
                                className={`player__translation ${
                                    selectedSettings === 'Озвучка'
                                        ? 'active'
                                        : ''
                                }`}
                            >
                                ...
                                <ul className='player__translations-list'>
                                    {renderedTranslations}
                                </ul>
                            </div>
                            <div
                                className={`player__player ${
                                    selectedSettings === 'Плеер' ? 'active' : ''
                                }`}
                            >
                                <div
                                    onClick={e =>
