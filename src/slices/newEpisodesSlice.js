...
const newEpisodesSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(fetchNewEpisodes.pending, (state) => {
      state.newEpisodesLoadingStatus = 'loading';
    });
    ...
    builder.addCase(fetchNewEpisodes.rejected, (state) => {
      state.newEpisodesLoadingStatus = 'error';
    });
